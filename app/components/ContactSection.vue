...
<template>
  <section id="contact" class="py-16 px-4 sm:px-6 max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="glass-card rounded-3xl p-6 sm:p-7 flex flex-col justify-between space-y-6">
        <div>
          ...
          <!-- Email Copy Box -->
          <div class="mt-4 p-3.5 rounded-2xl bg-zinc-900/90 border border-white/10 flex items-center justify-between gap-3">
            <div class="min-w-0">
            ...
            <button
              @click="copyEmail"
              class="p-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white transition-all btn-press shrink-0"
              title="Salin email"
            >
          ...
          <a
            ...
            class="mt-3 flex items-center justify-between p-3.5 rounded-2xl bg-zinc-900/60 hover:bg-zinc-800 border border-white/5 text-xs text-zinc-200 hover:text-white transition-all btn-press group"
          >
            ...
            <ArrowUpRight class="w-3.5 h-3.5 text-zinc-500 group-hover:text-white" />
          </a>
        </div>
        ...
        <div class="pt-4 border-t border-white/5 flex items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-2xl bg-zinc-900 hover:bg-zinc-800 border border-white/5 text-xs text-zinc-300 hover:text-white transition-all btn-press"
          >
      ...
      <div class="glass-card rounded-3xl p-6 sm:p-7">
        ...
        <form v-else @submit.prevent="handleSubmit" class="space-y-3">
          ...
          <button
            ...
            class="w-full py-2.5 rounded-xl bg-white text-zinc-950 hover:bg-zinc-200 font-bold text-xs transition-all btn-press shadow-md flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
          >
